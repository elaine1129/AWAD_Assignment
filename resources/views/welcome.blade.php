...
=======
    <button data-toggle="modal" data-target="#modal-test" type="button" class="btn btn-primary tw-bg-primary">Open</button>
>>>>>>> 68d50cdc0558e6ba455af2b5f7bfc153044d073b
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-secondary">Please Confirm</h4>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" data-dismiss="modal">Delete file</button>
            </div>
        </div>
    </div>
</div>
